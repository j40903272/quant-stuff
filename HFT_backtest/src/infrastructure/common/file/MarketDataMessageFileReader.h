#ifndef _MARKETDATAMESSAGEFILEREADER_H_
#define _MARKETDATAMESSAGEFILEREADER_H_
...
namespace alphaone
{
class MarketDataMessageFileReader
{
  public:
    MarketDataMessageFileReader(const std::string &filename);
    ~MarketDataMessageFileReader();
