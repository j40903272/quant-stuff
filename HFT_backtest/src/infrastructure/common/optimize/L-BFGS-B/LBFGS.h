...
#include "infrastructure/common/optimize/L-BFGS-B/LBFGSpp/LineSearchBacktracking.h"
#include "infrastructure/common/optimize/L-BFGS-B/LBFGSpp/LineSearchBracketing.h"
#include "infrastructure/common/optimize/L-BFGS-B/LBFGSpp/LineSearchNocedalWright.h"
...
///
template <typename Scalar, template <class> class LineSearch = LineSearchBacktracking>
class LBFGSSolver
{
  private:
  ...
  public:
    ...
    inline long unsigned int minimize(Foo &f, Vector &x, Scalar &fx)
    {
        using std::abs;
