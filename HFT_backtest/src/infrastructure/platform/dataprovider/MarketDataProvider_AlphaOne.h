#ifndef _MARKET_DATA_PROVIDER_ALPHAONE_H
#define _MARKET_DATA_PROVIDER_ALPHAONE_H

#include "infrastructure/base/MarketDataListener.h"
#include "infrastructure/base/MarketDataProvider.h"
#include "infrastructure/common/file/MarketDataMessageFileReader.h"
...
namespace alphaone
{
class MarketDataProvider_AlphaOne : public MarketDataProvider
{
  public:
    MarketDataProvider_AlphaOne();
    ~MarketDataProvider_AlphaOne();
  ...
  private:
    ...
    bool                         is_finished_;
    MarketDataMessageFileReader *reader_;
